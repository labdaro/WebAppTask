            ...
            <!-- Navigation -->
              <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="update.jsp">
            ...
            <div class="container text-center" style="display: inline-block; margin-left: 420px">
                <div style="text-align: center;">
                    <div class="col-lg-7 text-left" style="margin-left: 20px">
                        <h2 class="section-title mb-3" style="color: red; font-size: 28px">Data Update</h2>
                        <h3 class="lead"> Insert Your ID and New Name</h3>
                    </div>
                </div>
